            ...
            <div class="d-flex flex-column flex-md-row justify-content-between align-items-md-center gap-3">
                <div>
                    ...
                    <p class="hero-subtitle mb-0">
                        Rekapitulasi komprehensif 4 pilar indikator KPI (masing-masing 25.00%) dan klasifikasi 4 tingkat level karir pendidik MI Al-Husna.
                    </p>
                </div>
                <div>
        ...
        <table class="table table-noor align-middle">
            <thead>
                <tr>
                    ...
                    <th>Nama Pendidik</th>
                    <th>Posisi</th>
                    <th>Pilar 1: Pedagogik (25%)</th>
                    <th>Pilar 2: Profesional (25%)</th>
                    <th>Pilar 3: Kepribadian (25%)</th>
                    <th>Pilar 4: Sosial 360° (25%)</th>
                    <th>Total Skor</th>
            ...
            <tbody>
                <?php foreach ($rekapData as $idx => $item): ?>
                    ...
                    <tr>
                        ...
                        <td><?= $p ? number_format((float)$p['skor_pilar_1'], 2) : '0.00' ?>%</td>
                        <td><?= $p ? number_format((float)$p['skor_pilar_2'], 2) : '0.00' ?>%</td>
                        <td><?= $p ? number_format((float)$p['skor_pilar_3'], 2) : '0.00' ?>%</td>
                        <td><?= $p ? number_format((float)$p['skor_pilar_4'], 2) : '0.00' ?>%</td>
                        <td><span class="fw-extrabold text-success fs-6"><?= $p ? number_format((float)$p['nilai_akhir_total'], 2) : '0.00' ?></span></td>
                        <td>
